...
Version  : 1.2.4
Release  : 4
URL      : https://github.com/alsa-project/alsa-ucm-conf/archive/v1.2.4/alsa-ucm-conf-1.2.4.tar.gz
Source0  : https://github.com/alsa-project/alsa-ucm-conf/archive/v1.2.4/alsa-ucm-conf-1.2.4.tar.gz
...
%prep
%setup -q -n alsa-ucm-conf-1.2.4
cd %{_builddir}/alsa-ucm-conf-1.2.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603479969
...
cp %{_builddir}/alsa-ucm-conf-1.2.4/LICENSE %{buildroot}/usr/share/package-licenses/alsa-ucm-conf/27f14a443d8b2c78e6684ac3bb2fee5d8364c78f
%make_install
