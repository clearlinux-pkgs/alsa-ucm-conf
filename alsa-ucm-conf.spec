...
Source0  : https://www.alsa-project.org/files/pub/lib/alsa-ucm-conf-1.2.8.tar.bz2
Source1  : https://www.alsa-project.org/files/pub/lib/alsa-ucm-conf-1.2.8.tar.bz2.sig
...
%prep
%setup -q -n alsa-ucm-conf-1.2.8
cd %{_builddir}/alsa-ucm-conf-1.2.8
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666832195
...
/usr/share/alsa/ucm2/USB-Audio/Focusrite/Scarlett-2i4-gen2-HiFi.conf
/usr/share/alsa/ucm2/USB-Audio/Focusrite/Scarlett-2i4-gen2.conf
