...
Source0  : https://www.alsa-project.org/files/pub/lib/alsa-ucm-conf-1.2.11.tar.bz2
Source1  : https://www.alsa-project.org/files/pub/lib/alsa-ucm-conf-1.2.11.tar.bz2.sig
...
%prep
%setup -q -n alsa-ucm-conf-1.2.11
cd %{_builddir}/alsa-ucm-conf-1.2.11
%patch -P 1 -p1
pushd ..
cp -a alsa-ucm-conf-1.2.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706627926
