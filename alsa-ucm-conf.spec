...
Version  : 1.2.3
Release  : 3
URL      : https://github.com/alsa-project/alsa-ucm-conf/archive/v1.2.3/alsa-ucm-conf-1.2.3.tar.gz
Source0  : https://github.com/alsa-project/alsa-ucm-conf/archive/v1.2.3/alsa-ucm-conf-1.2.3.tar.gz
...
%prep
%setup -q -n alsa-ucm-conf-1.2.3
cd %{_builddir}/alsa-ucm-conf-1.2.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591819594
...
cp %{_builddir}/alsa-ucm-conf-1.2.3/LICENSE %{buildroot}/usr/share/package-licenses/alsa-ucm-conf/27f14a443d8b2c78e6684ac3bb2fee5d8364c78f
%make_install
...
/usr/share/alsa/ucm2/DB845c/DB845c.conf
/usr/share/alsa/ucm2/DB845c/HDMI.conf
/usr/share/alsa/ucm2/DB845c/HiFi.conf
...
/usr/share/alsa/ucm2/chtrt5645/ASUSTeKCOMPUTERINC.-T100HAN-1.0.conf
...
/usr/share/alsa/ucm2/chtrt5645/MEDION-E1239TMD60568-0.1-Wingman.conf
...
/usr/share/alsa/ucm2/sof-bdw-rt5677/HiFi.conf
/usr/share/alsa/ucm2/sof-bdw-rt5677/sof-bdw-rt5677.conf
